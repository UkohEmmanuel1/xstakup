    ...
    <>
            ...
            <div className="absolute inset-0 rounded-2xl glass overflow-hidden">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <svg viewBox="0 0 200 200" className="w-3/4 h-3/4">
                  ...
                  <circle cx="100" cy="100" r="4" fill="#00D1FF" />
                </svg>
              </div>
            </div>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {differentiators.map((d, i) => (
              <div key={d.t} className="relative rounded-xl glass p-8">
      ...
      <section className="py-24">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {values.map((v) => (
              <div key={v.t} className="rounded-xl glass p-6 hover:border-signal/40 transition-all">
      ...
      <section className="py-24 bg-[color:var(--void-section)] border-y border-border">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {leaders.map((l, i) => (
              <div key={i} className="group rounded-xl glass overflow-hidden hover:shadow-quantum transition-all">
                <div
                ...
                >
                  ...
                  <div className="absolute inset-0 flex items-center justify-center text-6xl font-mono text-white/80">
                    {l.name.charAt(0)}
                  </div>
                </div>
                <div className="p-5">
      ...
      <section className="py-24">
        <div className="mx-auto max-w-7xl px-6 text-center">
          ...
          <div className="relative mx-auto mt-12 max-w-3xl aspect-[2/1]">
            <div className="absolute inset-0 rounded-2xl glass overflow-hidden">
