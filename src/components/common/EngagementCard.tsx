...
export function EngagementCard({ item, index }: Props) {
  return (
    ...
    >
      <div className="rounded-xl border border-border bg-card p-6 md:p-8 hover:shadow-card-hover hover:border-blue/30 transition-all duration-300 h-full flex flex-col">
