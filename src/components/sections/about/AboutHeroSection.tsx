...
export function AboutHeroSection() {
  return (
    ...
    >
      ...
      />
      <div className="relative mx-auto max-w-5xl px-6 pt-16 pb-20 md:pt-32 text-center">
        <motion.h1
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.7, delay: 0.2 }}
          className="mt-6 text-2xl sm:text-3xl md:text-6xl lg:text-7xl font-bold tracking-tight max-w-4xl mx-auto"
        >
          Custom Enterprise Software Development{" "}
          <span className="text-gradient-quantum">Engineering Digital Commerce</span> and
