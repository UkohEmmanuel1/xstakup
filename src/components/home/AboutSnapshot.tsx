        ...
        <div className="flex flex-col lg:flex-row gap-12 items-start">
          <div className="flex-1 max-w-xl">
            ...
            <p className="mt-4 text-base text-muted-foreground leading-relaxed">
              A leading software development agency delivering full-stack engineering, cloud
              infrastructure, and technical strategy that transforms businesses with cutting-edge
              technology.
            </p>
          </div>
