import { AnimatedSection } from "@/components/common"; // removed unused SectionLabel
...
export function MarqueeSection() {
  return (
    <AnimatedSection>
      <section
        className="py-20 relative bg-[color:var(--void-section)] border-y border-border bg-cover bg-center bg-no-repeat overflow-hidden"
      ...
      >
        ...
        <div className="relative">
          ...
          <div className="flex animate-marquee gap-12 w-max group hover:[animation-play-state:paused]" role="list" aria-label="Technology stack">
